                       ...
                       return (
                        <Link href={`/ProposePage/${id}`}>
                         <div className={styles.project_item} key={id}>
                          ...
                          <div className={styles.project_grid}>
                               {
                    data?.slice(0, visible)?.map(({ id, time, problemTitle, desc, lowest, etherAmount, voteButton, approvedButton, approvedTitle }) => {
                       return (
                        <Link href={`/ProposePage/${id}`}>
                         <div className={styles.project_item} key={id}>
                            <div className={styles.project_img}>
                            ...
                            <div className={styles.project_text}>
                              <div className={styles.project_time}>{time}</div>
                              <div className={styles.project_titled}>{approvedTitle}</div>
                              <div className={styles.project_desc}>
                              {desc}
                              </div>
                              <div className={styles.project_voteTiming}>
                                 ...
                                 <div className={styles.right_item}>
                                  <button className={styles.button}>{approvedButton}</button>
                                 </div>
                              </div>
                           </div> 
                         </div>
